...
WORKDIR /src
COPY ["SpriteSplitter.Api/SpriteSplitter.Api.csproj", "SpriteSplitter.Api/"]
RUN dotnet restore "SpriteSplitter.Api/SpriteSplitter.Api.csproj"
COPY . .
WORKDIR "/src/SpriteSplitter.Api"
